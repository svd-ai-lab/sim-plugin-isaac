...
from sim_plugin_isaac import IsaacDriver

FIX = Path(__file__).parent.parent / "fixtures" / "isaac"
...
class TestDetectInstalled:
    def test_no_env_no_import_returns_empty(self, driver, monkeypatch):
        ...
        monkeypatch.setattr("sim_plugin_isaac.driver._probe_python", fake_probe)
