...
hatchling picks it up via ``packages = ["src/sim_plugin_isaac"]``
...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_isaac-*.whl"))
    ...
    required = {
        "sim_plugin_isaac/__init__.py",
        "sim_plugin_isaac/driver.py",
        "sim_plugin_isaac/_skills/isaac/SKILL.md",
    }
